...
describe "Editing todo lists" do
	# create a todo_list before each of the tests and assign it to a variable
	...
	it "updates a todo list successfully with correct information" do
		...
		# we have to reload it, otherwise it will use the one in memory, not the one updated
		# in database
